	...
	\begin{example}	
		\begin{columns}	
			...
			\begin{tikzpicture}
				...
				\filldraw[color = cyan!20] (0,0) circle [radius=1];
				\filldraw[red!20] (0,0) circle [radius=0.5];
				\filldraw[yellow!20, rotate = 30] (1,1) ellipse (0.7 and 0.5);
				\begin{scope}
					\clip (0,0) circle [radius=1];
					\fill[blue!15, rotate = 30] (1,1) ellipse (0.7 and 0.5);
				\end{scope}				
				\draw (0.5,1.4) node{$C$};
				\draw (0,0) node{$A$};
				\draw (0.7,0) node{$B$};
	...
	\begin{example}
		...
		\begin{columns}
			...
			\column{0.38\textwidth}
				...
				\begin{tikzpicture}
				\draw(-1.8,-2.8)--(1.8,-2.8)--(1.8,2.8)node[above left]{$X$}--(-1.8,2.8)--(-1.8,-2.8);
