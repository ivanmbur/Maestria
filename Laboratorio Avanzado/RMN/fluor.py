...
plt.legend(loc=4)
plt.text(0.5425, 17.6, r'$f=mB+c$',fontsize=15)
plt.text(0.5425, 17.5,r'$m=19(7)MHz/T$',fontsize=15)
plt.text(0.5425, 17.4,r'$c=7(4)MHz$',fontsize=15)
plt.text(0.5425, 17.3,r'$R^2=0.98(10)$',fontsize=15)
